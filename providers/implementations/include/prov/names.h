...
#define PROV_NAMES_MLDSA44_RSA2048_PSS_SHA256 \
    "ML-DSA-44-RSA2048-PSS-SHA256:id-mldsa44-rsa2048-pss-sha256:1.3.6.1.5.5.7.6.37"
#define PROV_DESCS_MLDSA44_RSA2048_PSS_SHA256 \
    "OpenSSL ML-DSA-44-RSA2048-PSS-SHA256 composite implementation"
#define PROV_NAMES_MLDSA44_RSA2048_PKCS15_SHA256 \
    "ML-DSA-44-RSA2048-PKCS15-SHA256:id-mldsa44-rsa2048-pkcs15-sha256:1.3.6.1.5.5.7.6.38"
#define PROV_DESCS_MLDSA44_RSA2048_PKCS15_SHA256 \
    "OpenSSL ML-DSA-44-RSA2048-PKCS15-SHA256 composite implementation"
#define PROV_NAMES_MLDSA44_ED25519_SHA512 \
    "ML-DSA-44-Ed25519-SHA512:id-mldsa44-ed25519-sha512:1.3.6.1.5.5.7.6.39"
#define PROV_DESCS_MLDSA44_ED25519_SHA512 \
    "OpenSSL ML-DSA-44-Ed25519-SHA512 composite implementation"
#define PROV_NAMES_MLDSA44_ECDSA_P256_SHA256 \
    "ML-DSA-44-ECDSA-P256-SHA256:id-mldsa44-ecdsa-p256-sha256:1.3.6.1.5.5.7.6.40"
#define PROV_DESCS_MLDSA44_ECDSA_P256_SHA256 \
    "OpenSSL ML-DSA-44-ECDSA-P256-SHA256 composite implementation"
#define PROV_NAMES_MLDSA65_RSA3072_PSS_SHA512 \
    "ML-DSA-65-RSA3072-PSS-SHA512:id-mldsa65-rsa3072-pss-sha512:1.3.6.1.5.5.7.6.41"
#define PROV_DESCS_MLDSA65_RSA3072_PSS_SHA512 \
    "OpenSSL ML-DSA-65-RSA3072-PSS-SHA512 composite implementation"
...
#define PROV_DESCS_MLDSA65_RSA3072_PKCS15_SHA512 \
    "OpenSSL ML-DSA-65-RSA3072-PKCS15-SHA512 composite implementation"
#define PROV_NAMES_MLDSA65_RSA4096_PSS_SHA512 \
    "ML-DSA-65-RSA4096-PSS-SHA512:id-mldsa65-rsa4096-pss-sha512:1.3.6.1.5.5.7.6.43"
#define PROV_DESCS_MLDSA65_RSA4096_PSS_SHA512 \
    "OpenSSL ML-DSA-65-RSA4096-PSS-SHA512 composite implementation"
#define PROV_NAMES_MLDSA65_RSA4096_PKCS15_SHA512 \
    "ML-DSA-65-RSA4096-PKCS15-SHA512:id-mldsa65-rsa4096-pkcs15-sha512:1.3.6.1.5.5.7.6.44"
#define PROV_DESCS_MLDSA65_RSA4096_PKCS15_SHA512 \
    "OpenSSL ML-DSA-65-RSA4096-PKCS15-SHA512 composite implementation"
...
#define PROV_DESCS_MLDSA65_ECDSA_P256_SHA512 \
    "OpenSSL ML-DSA-65-ECDSA-P256-SHA512 composite implementation"
#define PROV_NAMES_MLDSA65_ECDSA_P384_SHA512 \
    "ML-DSA-65-ECDSA-P384-SHA512:id-mldsa65-ecdsa-p384-sha512:1.3.6.1.5.5.7.6.46"
#define PROV_DESCS_MLDSA65_ECDSA_P384_SHA512 \
    "OpenSSL ML-DSA-65-ECDSA-P384-SHA512 composite implementation"
#define PROV_NAMES_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512 \
    "ML-DSA-65-ECDSA-brainpoolP256r1-SHA512:id-mldsa65-ecdsa-brainpoolP256r1-sha512:1.3.6.1.5.5.7.6.47"
#define PROV_DESCS_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512 \
    "OpenSSL ML-DSA-65-ECDSA-brainpoolP256r1-SHA512 composite implementation"
#define PROV_NAMES_MLDSA65_ED25519_SHA512 \
    "ML-DSA-65-Ed25519-SHA512:id-mldsa65-ed25519-sha512:1.3.6.1.5.5.7.6.48"
#define PROV_DESCS_MLDSA65_ED25519_SHA512 \
    "OpenSSL ML-DSA-65-Ed25519-SHA512 composite implementation"
#define PROV_NAMES_MLDSA87_ECDSA_P384_SHA512 \
    "ML-DSA-87-ECDSA-P384-SHA512:id-mldsa87-ecdsa-p384-sha512:1.3.6.1.5.5.7.6.49"
#define PROV_DESCS_MLDSA87_ECDSA_P384_SHA512 \
    "OpenSSL ML-DSA-87-ECDSA-P384-SHA512 composite implementation"
#define PROV_NAMES_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512 \
    "ML-DSA-87-ECDSA-brainpoolP384r1-SHA512:id-mldsa87-ecdsa-brainpoolp384r1-sha512:1.3.6.1.5.5.7.6.50"
#define PROV_DESCS_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512 \
    "OpenSSL ML-DSA-87-ECDSA-brainpoolP384r1-SHA512 composite implementation"
#define PROV_NAMES_MLDSA87_ED448_SHAKE256 \
    "ML-DSA-87-Ed448-SHAKE256:id-mldsa87-ed448-shake256:1.3.6.1.5.5.7.6.51"
#define PROV_DESCS_MLDSA87_ED448_SHAKE256 \
    "OpenSSL ML-DSA-87-Ed448-SHAKE256 composite implementation"
#define PROV_NAMES_MLDSA87_RSA3072_PSS_SHA512 \
    "ML-DSA-87-RSA3072-PSS-SHA512:id-mldsa87-rsa3072-pss-sha512:1.3.6.1.5.5.7.6.52"
#define PROV_DESCS_MLDSA87_RSA3072_PSS_SHA512 \
    "OpenSSL ML-DSA-87-RSA3072-PSS-SHA512 composite implementation"
#define PROV_NAMES_MLDSA87_RSA4096_PSS_SHA512 \
    "ML-DSA-87-RSA4096-PSS-SHA512:id-mldsa87-rsa4096-pss-sha512:1.3.6.1.5.5.7.6.53"
#define PROV_DESCS_MLDSA87_RSA4096_PSS_SHA512 \
    "OpenSSL ML-DSA-87-RSA4096-PSS-SHA512 composite implementation"
#define PROV_NAMES_MLDSA87_ECDSA_P521_SHA512 \
    "ML-DSA-87-ECDSA-P521-SHA512:id-mldsa87-ecdsa-p521-sha512:1.3.6.1.5.5.7.6.54"
#define PROV_DESCS_MLDSA87_ECDSA_P521_SHA512 \
    "OpenSSL ML-DSA-87-ECDSA-P521-SHA512 composite implementation"
