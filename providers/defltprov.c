...
static const OSSL_ALGORITHM deflt_signature[] = {
    ...
    { PROV_NAMES_MLDSA44_RSA2048_PSS_SHA256, "provider=default",
        ossl_mldsa44_rsa2048_pss_sha256_signature_functions,
        PROV_DESCS_MLDSA44_RSA2048_PSS_SHA256 },
    { PROV_NAMES_MLDSA44_RSA2048_PKCS15_SHA256, "provider=default",
        ossl_mldsa44_rsa2048_pkcs15_sha256_signature_functions,
        PROV_DESCS_MLDSA44_RSA2048_PKCS15_SHA256 },
    { PROV_NAMES_MLDSA44_ED25519_SHA512, "provider=default",
        ossl_mldsa44_ed25519_sha512_signature_functions,
        PROV_DESCS_MLDSA44_ED25519_SHA512 },
    { PROV_NAMES_MLDSA44_ECDSA_P256_SHA256, "provider=default",
        ossl_mldsa44_ecdsa_p256_sha256_signature_functions,
        PROV_DESCS_MLDSA44_ECDSA_P256_SHA256 },
    { PROV_NAMES_MLDSA65_RSA3072_PSS_SHA512, "provider=default",
        ossl_mldsa65_rsa3072_pss_sha512_signature_functions,
    ...
    { PROV_NAMES_MLDSA65_RSA4096_PSS_SHA512, "provider=default",
        ossl_mldsa65_rsa4096_pss_sha512_signature_functions,
        PROV_DESCS_MLDSA65_RSA4096_PSS_SHA512 },
    { PROV_NAMES_MLDSA65_RSA4096_PKCS15_SHA512, "provider=default",
        ossl_mldsa65_rsa4096_pkcs15_sha512_signature_functions,
    ...
    { PROV_NAMES_MLDSA65_ECDSA_P384_SHA512, "provider=default",
        ossl_mldsa65_ecdsa_p384_sha512_signature_functions,
        PROV_DESCS_MLDSA65_ECDSA_P384_SHA512 },
    { PROV_NAMES_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512, "provider=default",
        ossl_mldsa65_ecdsa_brainpoolP256r1_sha512_signature_functions,
        PROV_DESCS_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512 },
    { PROV_NAMES_MLDSA65_ED25519_SHA512, "provider=default",
        ossl_mldsa65_ed25519_sha512_signature_functions,
        PROV_DESCS_MLDSA65_ED25519_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_P384_SHA512, "provider=default",
        ossl_mldsa87_ecdsa_p384_sha512_signature_functions,
        PROV_DESCS_MLDSA87_ECDSA_P384_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512, "provider=default",
        ossl_mldsa87_ecdsa_brainpoolP384r1_sha512_signature_functions,
        PROV_DESCS_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512 },
    { PROV_NAMES_MLDSA87_ED448_SHAKE256, "provider=default",
        ossl_mldsa87_ed448_shake256_signature_functions,
        PROV_DESCS_MLDSA87_ED448_SHAKE256 },
    { PROV_NAMES_MLDSA87_RSA3072_PSS_SHA512, "provider=default",
        ossl_mldsa87_rsa3072_pss_sha512_signature_functions,
        PROV_DESCS_MLDSA87_RSA3072_PSS_SHA512 },
    { PROV_NAMES_MLDSA87_RSA4096_PSS_SHA512, "provider=default",
        ossl_mldsa87_rsa4096_pss_sha512_signature_functions,
        PROV_DESCS_MLDSA87_RSA4096_PSS_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_P521_SHA512, "provider=default",
        ossl_mldsa87_ecdsa_p521_sha512_signature_functions,
        PROV_DESCS_MLDSA87_ECDSA_P521_SHA512 },
...
static const OSSL_ALGORITHM deflt_keymgmt[] = {
...
#ifndef OPENSSL_NO_COMPOSITE
    { PROV_NAMES_MLDSA44_RSA2048_PSS_SHA256, "provider=default", ossl_mldsa44_rsa2048_pss_sha256_keymgmt_functions, PROV_DESCS_MLDSA44_RSA2048_PSS_SHA256 },
    { PROV_NAMES_MLDSA44_RSA2048_PKCS15_SHA256, "provider=default", ossl_mldsa44_rsa2048_pkcs15_sha256_keymgmt_functions, PROV_DESCS_MLDSA44_RSA2048_PKCS15_SHA256 },
    { PROV_NAMES_MLDSA44_ED25519_SHA512, "provider=default", ossl_mldsa44_ed25519_sha512_keymgmt_functions, PROV_DESCS_MLDSA44_ED25519_SHA512 },
    { PROV_NAMES_MLDSA44_ECDSA_P256_SHA256, "provider=default", ossl_mldsa44_ecdsa_p256_sha256_keymgmt_functions, PROV_DESCS_MLDSA44_ECDSA_P256_SHA256 },
    { PROV_NAMES_MLDSA65_RSA3072_PSS_SHA512, "provider=default", ossl_mldsa65_rsa3072_pss_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_RSA3072_PSS_SHA512 },
    ...
    { PROV_NAMES_MLDSA65_RSA4096_PSS_SHA512, "provider=default", ossl_mldsa65_rsa4096_pss_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_RSA4096_PSS_SHA512 },
    { PROV_NAMES_MLDSA65_RSA4096_PKCS15_SHA512, "provider=default", ossl_mldsa65_rsa4096_pkcs15_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_RSA4096_PKCS15_SHA512 },
    ...
    { PROV_NAMES_MLDSA65_ECDSA_P384_SHA512, "provider=default", ossl_mldsa65_ecdsa_p384_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_ECDSA_P384_SHA512 },
    { PROV_NAMES_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512, "provider=default", ossl_mldsa65_ecdsa_brainpoolP256r1_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_ECDSA_BRAINPOOLP256R1_SHA512 },
    { PROV_NAMES_MLDSA65_ED25519_SHA512, "provider=default", ossl_mldsa65_ed25519_sha512_keymgmt_functions, PROV_DESCS_MLDSA65_ED25519_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_P384_SHA512, "provider=default", ossl_mldsa87_ecdsa_p384_sha512_keymgmt_functions, PROV_DESCS_MLDSA87_ECDSA_P384_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512, "provider=default", ossl_mldsa87_ecdsa_brainpoolP384r1_sha512_keymgmt_functions, PROV_DESCS_MLDSA87_ECDSA_BRAINPOOLP384R1_SHA512 },
    { PROV_NAMES_MLDSA87_ED448_SHAKE256, "provider=default", ossl_mldsa87_ed448_shake256_keymgmt_functions, PROV_DESCS_MLDSA87_ED448_SHAKE256 },
    { PROV_NAMES_MLDSA87_RSA3072_PSS_SHA512, "provider=default", ossl_mldsa87_rsa3072_pss_sha512_keymgmt_functions, PROV_DESCS_MLDSA87_RSA3072_PSS_SHA512 },
    { PROV_NAMES_MLDSA87_RSA4096_PSS_SHA512, "provider=default", ossl_mldsa87_rsa4096_pss_sha512_keymgmt_functions, PROV_DESCS_MLDSA87_RSA4096_PSS_SHA512 },
    { PROV_NAMES_MLDSA87_ECDSA_P521_SHA512, "provider=default", ossl_mldsa87_ecdsa_p521_sha512_keymgmt_functions, PROV_DESCS_MLDSA87_ECDSA_P521_SHA512 },
#endif /* OPENSSL_NO_COMPOSITE */
#endif /* OPENSSL_NO_ML_DSA */
